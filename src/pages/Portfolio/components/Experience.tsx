  ...
  return (
    ...
    >
      <section id="experience" className="min-h-screen flex items-center py-20 px-4 relative">
        <motion.div className="max-w-6xl mx-auto relative z-10" {...fadeIn()} viewport={{ once: true }}>
          <motion.h2
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {job.tech.map((item, techIndex) => (
                      <motion.span
                        key={item}
                        className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm border border-primary/30 shadow-black shadow-md"
